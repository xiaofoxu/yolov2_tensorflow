...
train_data_path = '../darknet/train.txt'
object_scale = 5
noobject_scale = 1
class_scale = 1
coord_scale = 1
...
scale = 1
threshold = 0.5
anchors = np.array([0.738768, 0.874946,  2.42204, 2.65704,  4.30971, 7.04493,  10.246, 4.59428,  12.6868, 11.8741],
                   dtype=np.float32)
weight_dir = '../nets/weights/'
out_file = '../nets/ckpt/yolo_hgx.ckpt'
iou_threshold = 0.4
cls = ['person', 'bicycle', 'car', 'motorbike', 'aeroplane', 'bus', 'train', 'truck', 'boat', 'traffic light',
